...
/** @type {string} */
const CACHE_VERSION = '1742176637|15565393023';
/** @type {string} */
const CACHE_PREFIX = 'MiniJam1-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Soarfall.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Soarfall.html","Soarfall.js","Soarfall.offline.html","Soarfall.icon.png","Soarfall.apple-touch-icon.png","Soarfall.audio.worklet.js","Soarfall.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Soarfall.wasm","Soarfall.pck"];
